...
//     discovery.startPairingDiscovery((device) =>
//       event.sender.send(CHANNELS.adbOnPairingDevice, device),
//     );
//     return true;
//   },
...
//     discovery.startConnectDiscovery((device) =>
//       event.sender.send(CHANNELS.adbOnConnectDevice, device),
//     );
//     return true;
//   },
