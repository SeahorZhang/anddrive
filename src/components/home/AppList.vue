...
// 组件只做组合与渲染：数据加载/启动意图/MRU 分别在两个 composable 内维护
const installed = useInstalledApps(() => props.serial)
const launcher = useAppLauncher(() => props.serial, installed)

const searchText = ref('')

const { loading } = installed
const {
  displayApps: apps,
  pendingIconLaunches,
  launchingPackages,
